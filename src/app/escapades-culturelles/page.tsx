      ...
      <div className={`${plusJakarta.className} relative flex min-h-screen w-full flex-col bg-[#F9F8F6] text-abyss`}>
          ...
          <main className="mx-auto w-full max-w-[1200px] px-6 pb-20 pt-40">
                  ...
                  <article className="journal-entry group">
                              ...
                              <div className="itinerary-overlay absolute inset-0 flex items-center justify-center bg-abyss/85 p-12 opacity-0 transition-opacity duration-500 group-hover:opacity-100">
                                  <div className="flex w-full max-w-6xl items-center gap-16">
                                      <div className="relative h-64 flex-1">
                                          ...
                                          >
                                              <path
                                                  d="M50 100C70 80 150 40 200 40C250 40 330 80 350 150"
                                                  stroke="currentColor"
                                                  strokeDasharray="4 4"
                                                  strokeWidth="1.5"
                                              />
                                          ...
                                          <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
                                              <span className="text-[80px] font-serif uppercase tracking-widest text-white opacity-5">
                                                  Itinéraire
                                              </span>
                                          </div>
                                      </div>
                                      <div className="w-72 font-inter text-[11px] leading-loose text-ecru/90">
                                          <h5 className="mb-6 border-b border-primary/30 pb-2 text-primary font-bold uppercase tracking-[0.2em]">
                      ...
                      <div className="journal-content flex flex-col items-start gap-16 lg:flex-row">
                          <div className="flex-1">
                              <div className="mb-8">
                                  <h3 className="serif-heading mb-6 text-5xl leading-tight text-abyss">
                                      Sagas Islandaises : Terres de Feu et
                                      d'Espace
                                  </h3>
                                  <p className="mb-8 text-sm font-bold uppercase tracking-[0.2em] text-primary">
                                      Invitée d'honneur : Elsa Magnusdottir,
                                      Spécialiste de la Littérature Nordique
                                  </p>
                              </div>
                              <div className="prose prose-lg max-w-2xl space-y-6 font-serif leading-relaxed text-abyss/70">
                                  <p>
                                      Une épopée maritime autour de l'Islande,
                                      où la géologie spectaculaire rencontre les
                                      récits légendaires du Moyen Âge. Découvrez
                                      comment ce paysage tourmenté a façonné
                                      l'une des littératures les plus riches
                                      d'Europe.
                                  </p>
                                  <p>
                                      Le cycle "Voix de Glace" explore
                                      l'héritage des Eddas et des Sagas à
                                      travers des lectures quotidiennes et des
                                      conférences sur le terrain, au pied des
                                      glaciers ou sur les champs de lave, pour
                                      une résonance totale entre texte et
                                      territoire.
                                  </p>
                              </div>
                          </div>
                          <aside className="flex-shrink-0 space-y-10 border-l border-abyss/10 pl-10 lg:w-72">
                              <div>
                                  <span className="mb-4 block text-[10px] font-bold uppercase tracking-[0.2em] opacity-40">
                                      Dates & Durée
                                  </span>
                              ...
                              <div>
                                  ...
                                  <p className="text-2xl font-bold text-abyss">
                                      4,990 €
                                  </p>
                  ...
                  <article className="journal-entry group">
                              ...
                              <div className="itinerary-overlay absolute inset-0 flex items-center justify-center bg-abyss/85 p-12 opacity-0 transition-opacity duration-500 group-hover:opacity-100">
                                  <div className="flex w-full max-w-6xl items-center gap-16">
                                      <div className="relative h-64 flex-1">
                                          ...
                                          >
                                              <path
                                                  d="M50 100 Q 150 150, 250 100 T 350 100"
                                                  stroke="currentColor"
                                                  strokeDasharray="4 4"
                                                  strokeWidth="1.5"
                                              />
                      ...
                      <div className="journal-content flex flex-col items-start gap-16 lg:flex-row">
                          <div className="flex-1">
                              <div className="mb-8">
                                  <h3 className="serif-heading mb-6 text-5xl leading-tight text-abyss">
                                      Le Danube Impérial : Musique et
                                      Architecture
                                  </h3>
                                  <p className="mb-8 text-sm font-bold uppercase tracking-[0.2em] text-primary">
                                      Conférencier : Pierre-Etienne Durand,
                                      Musicologue & Historien de l'Art
                                  </p>
                              </div>
                              <div className="prose prose-lg max-w-2xl space-y-6 font-serif leading-relaxed text-abyss/70">
                                  <p>
                                      De Vienne à Budapest, cette croisière
                                      fluviale célèbre le faste de l'Empire
                                      austro-hongrois. Un voyage rythmé par les
                                      accords de Mozart et de Liszt dans les
                                      décors baroques et Art Nouveau qui bordent
                                      le fleuve bleu.
                                  </p>
                                  <p>
                                      Le cycle de conférences "L'Harmonie du
                                      Danube" déchiffrera les liens étroits
                                      entre les courants architecturaux de la
                                      Sécession et l'évolution de la musique
                                      symphonique européenne, complété par des
                                      escales privées dans des salles de concert
                                      historiques.
                                  </p>
                              </div>
                          </div>
              ...
              <div className="mt-32 border-t border-abyss/10 pt-20">
                  ...
                  <div className="mt-6 text-center font-serif text-sm italic opacity-40">
                      Découvrir la suite de la collection
                  </div>
              </div>

              <section className="mt-40">
                  <div className="mb-20 h-px w-full bg-primary/20" />
                  <h3 className="serif-heading mb-12 text-center text-3xl italic">
                      Autres suggestions
                  </h3>
                  <div className="grid grid-cols-1 gap-12 px-4 md:grid-cols-4">
                      {suggestions.map((sugg) => (
                          ...
                          >
                              ...
                              <h4 className="mb-3 font-serif text-lg leading-snug transition-colors group-hover:text-primary">
                                  {sugg.title}
                              </h4>
                              ...
                              <a
                                  className="inline-block border-b border-abyss/20 pb-1 text-[10px] font-bold uppercase tracking-[0.2em] transition-all group-hover:border-primary"
                                  href="#"
                              >
                                  Découvrir
                              </a>
