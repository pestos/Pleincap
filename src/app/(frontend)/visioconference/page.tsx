      ...
      <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden bg-background-light text-abyss dark:bg-background-dark dark:text-ecru">
          ...
          <section className="relative flex h-[60vh] w-full items-center justify-center overflow-hidden pt-20">
              <div
                  ...
                  style={{
                      backgroundImage: `linear-gradient(rgba(26, 43, 60, 0.7), rgba(26, 43, 60, 0.7)), url(${heroImage})`,
                  }}
              />
              <div className="relative z-10 mx-auto max-w-[1600px] px-6 text-center text-white md:px-16">
                  ...
                  <p className="mx-auto max-w-2xl text-sm font-light leading-relaxed opacity-90">
                      Découvrez nos itinéraires exceptionnels depuis chez vous.
                      Nos experts vous présentent les destinations, navires et
                      expériences culturelles en direct ou en replay.
                  </p>
              </div>
          </section>
                  ...
                  <div className="mx-auto max-w-[1600px] px-6 md:px-16">
                      ...
                      <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                          {upcomingLive.map((conf) => (
                              <div
                                  key={conf.id}
                                  className="group relative overflow-hidden border border-primary/30"
                              >
              ...
              <div className="mx-auto max-w-[1600px] px-6 md:px-16">
                  <div className="mb-16 flex items-center justify-between border-b border-primary/20 pb-6">
                      ...
                      <span className="text-sm opacity-60">
                          {filteredConferences.length} conférence
                  ...
                  <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                      {filteredConferences.map((conf) => (
                          <div
                              key={conf.id}
                              className="group relative overflow-hidden border border-primary/20 bg-white transition-all duration-300 hover:shadow-xl"
                          >
                              <div className="relative aspect-video overflow-hidden">
                                  <img
                                      src={conf.thumbnail}
                                  ...
                                  />
                                  <div
                                      className={`absolute left-4 top-4 px-3 py-1.5 text-[9px] font-bold uppercase tracking-widest text-white ${
                                          conf.type === "live"
                                              ? "bg-primary"
                                              : "bg-abyss"
                                      }`}
                              ...
                              <div className="p-6">
                                  ...
                                  <button
                                      className={`sharp-edge w-full px-6 py-3 text-[10px] font-bold uppercase tracking-widest transition-all ${
                                          conf.type === "live"
              ...
              <div className="mx-auto max-w-[1600px] px-6 md:px-16">
                  <div className="mb-16 text-center">
                      ...
                      <p className="mx-auto max-w-2xl text-sm font-light leading-relaxed opacity-70">
                          Explorez nos destinations depuis le confort de votre
                          foyer avec nos experts passionnés
                      </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 gap-12 md:grid-cols-3">
                      <div className="text-center">
                          ...
                          <p className="text-sm font-light leading-relaxed opacity-70">
                              Toutes nos visioconférences sont entièrement
                              gratuites. Participez depuis chez vous, aucun
                      ...
                      <div className="text-center">
                          ...
                          <p className="text-sm font-light leading-relaxed opacity-70">
                              Nos conférenciers sont des historiens,
                              archéologues et guides professionnels qui
                              enrichissent nos voyages.
                          </p>
                      </div>
                      ...
                      <div className="text-center">
                          ...
                          <p className="text-sm font-light leading-relaxed opacity-70">
                              Posez vos questions en direct lors des sessions
                              live et obtenez des réponses personnalisées de nos
                              experts.
                          </p>
                      </div>
                  </div>
